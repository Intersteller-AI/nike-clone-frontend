    ...
    <div className="relative text-white text-[20px] w-full max-w-[1360px] mx-auto">
      <Carousel
        ...
        renderArrowPrev={(clickHandler, hasPrev) => (
          <div
            className="absolute right-[31px] md:right-[51px] bottom-0 w-[30x] md:w-[50px] h-[30px] md:h-[50px] bg-black z-10 md:flex hidden items-center justify-center cursor-pointer hover:opacity-90"
        ...
        renderArrowNext={(clickHandler, hasNext) => (
          <div
            className="absolute right-0 bottom-0 w-[30x] md:w-[50px] h-[30px] md:h-[50px] bg-black z-10 md:flex hidden items-center justify-center cursor-pointer hover:opacity-90"
            onClick={clickHandler}
          >
